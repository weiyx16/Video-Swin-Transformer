...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.2, frozen_stages=4), test_cfg=dict(max_testing_views=2))
...
optimizer = dict(type='SGD', lr=1.0, momentum=0.9, weight_decay=0.00001)
# learning policy
lr_config = dict(
